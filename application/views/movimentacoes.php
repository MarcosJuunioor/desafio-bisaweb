...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/desafio-bisaweb/assets/css/movimentacoes.css">
</head>
<body>
    ...
    <?php  
        if(!empty($movimentacoes)){
            ...
            echo "<a href='http://localhost/desafio-bisaweb/index.php/movimentacao_control/fazer_relatorio/$id_conta'><input type='button' value='RELATÓRIO' class='btn btn-link'/></a>";
            foreach($movimentacoes as $movimentacao){
                ...
                echo "
                <form id='id_atualizacao_movimentacao' class='forms' method='post' action='http://localhost/desafio-bisaweb/index.php/movimentacao_control/atualizar_movimentacao/$id_movimentacao/$id_conta'>
                    <div class='form-row'>
                        <div class='col'>
                            ...
                            <a href='http://localhost/desafio-bisaweb/index.php/movimentacao_control/excluir_movimentacao/$id_movimentacao/$id_conta'> <input type='button' value='deletar' id='id_deletar' class='btn btn-danger'/></a><br>                    
                        </div>
                    </div>
                </form>
                ";      
    ...
    <form id="id_cadastro_movimentacao" class="forms" method="post" action="http://localhost/desafio-bisaweb/index.php/movimentacao_control/criar_movimentacao/<?php echo $id_conta; ?>">
        <div class="form-row">
            <div class="card">
                <div class="card-body">
                    <div class='col'>
                        ...
                        <a href="http://localhost/desafio-bisaweb/index.php/conta_control/listar_contas"><input type="button" value="voltar" class="btn btn-link"/></a><br>
                    </div>
                </div>
            </div>
        </div>    
    ...
    <script src="http://localhost/desafio-bisaweb/assets/javascript/movimentacoes.js"></script>
</body>
</html>