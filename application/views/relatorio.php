...
<body>
    ...
    <?php 
        if(!empty($movimentacoes)){
            ...
            echo "<a href='http://localhost/desafio-bisaweb/index.php/movimentacao_control/listar_movimentacoes/$id_conta'><input type='button' value='VOLTAR' class='btn btn-link'/></a>";
